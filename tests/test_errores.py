...
_error_404/_error_500 en finanzas_server.py.
"""
import finanzas_server as app_module


def test_404_en_api_devuelve_json(client):
    r = client.get("/api/finanzas/ruta-que-no-existe")
...
def test_500_en_api_devuelve_json():
    with app_module.app.test_request_context("/api/finanzas/algo"):
...
def test_500_en_pagina_devuelve_html():
    with app_module.app.test_request_context("/finanzas/algo"):
